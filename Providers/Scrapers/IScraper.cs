...
namespace Jellyfin.Plugin.IvInfo.Providers.Scrapers
{
    public interface IScraper
    {
        ...
        /// <summary>
        /// Fills metadata for <see cref="MetadataResult{T}"/>. When <c>overwrite</c> is true then all (available) data is filled, otherwise only missing data is filled.
        /// </summary>
        ...
        /// <summary>
        /// Adds new image to list, if image of this type already exists in the list and overwrite is true then existing image is removed and new one added, otherwise nothing is done.
        /// </summary>
        /// <param name="images">list with images</param>
        /// <param name="imageType"><see cref="ImageType"/></param>
