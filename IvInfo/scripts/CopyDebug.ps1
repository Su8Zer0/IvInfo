...
Copy-Item ".\IvInfo\bin\Debug\net9.0\IvInfo.dll" -Destination "$( $JF_DIR )\data\plugins\IvInfo\"
Copy-Item ".\IvInfo\bin\Debug\net9.0\IvInfo.pdb" -Destination "$( $JF_DIR )\data\plugins\IvInfo\"
Copy-Item ".\IvInfo\bin\Debug\net9.0\publish\F23.StringSimilarity.dll" -Destination "$( $JF_DIR )\data\plugins\IvInfo\"
Copy-Item ".\IvInfo\bin\Debug\net9.0\publish\AngleSharp.dll" -Destination "$( $JF_DIR )\data\plugins\IvInfo\"
Copy-Item ".\IvInfo\bin\Debug\net9.0\publish\AngleSharp.XPath.dll" -Destination "$( $JF_DIR )\data\plugins\IvInfo\"
Copy-Item ".\IvInfo\bin\Debug\net9.0\publish\FlareSolverrSharp.dll" -Destination "$( $JF_DIR )\data\plugins\IvInfo\"
